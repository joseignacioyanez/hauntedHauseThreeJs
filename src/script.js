...
const grasssAmbientOcclusion = textureLoader.load('/textures/grass/ambientOcclusion.jpg')
...
const door = new THREE.Mesh(
    new THREE.PlaneGeometry(2.2,2.2, 100, 100), // Subdivisions for displacement height map
    new THREE.MeshStandardMaterial({ 
        map: doorColorTexture,
        transparent: true,
        alphaMap: doorAlphaTexture,
        aoMap: doorAmbientOcclusionTexture, // needs uv2
...
const tick = () =>
{
    ...
    ghost3.position.x = Math.cos(ghostAngle) * (7 + Math.sin(elapsedTime * 0.32))
